-- Generated from include/config.h by scripts/generate_telemetry_lua.py.
...
local fields = {
  ...
  { name="accel1X", type="float", size=4, offset=11 },
  { name="accel1Y", type="float", size=4, offset=15 },
  { name="accel1Z", type="float", size=4, offset=19 },
