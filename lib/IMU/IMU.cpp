...
bool IMU::readData(IMUData& dataOut) {
    ...
    dataOut.xMps2 = ((x_12bit * _sensitivityGPerLsb) - _offsetXG) * STANDARD_GRAVITY_MPS2;
    dataOut.yMps2 = ((y_12bit * _sensitivityGPerLsb) - _offsetYG) * STANDARD_GRAVITY_MPS2;
    dataOut.zMps2 = ((z_12bit * _sensitivityGPerLsb) - _offsetZG) * STANDARD_GRAVITY_MPS2;
